...
$string['form:course:subsectionsascards'] = 'Subsection style';
$string['form:course:subsectionsascards:cards'] = 'As cards';
$string['form:course:subsectionsascards:activity'] = 'As an activity';
