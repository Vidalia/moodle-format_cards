...
$string['form:course:subsectionscollapsed'] = 'Autocollapse subsections';
$string['form:course:subsectionscollapsed:collapsed'] = 'Subsections start collapsed';
$string['form:course:subsectionscollapsed:expanded'] = 'Subsections start expanded';
...
$string['settings:defaultscards'] = 'Display defaults';
$string['settings:defaultscards:description'] = 'Default values for how cards are displayed';
$string['settings:defaultsnavigation'] = 'Navigation defaults';
$string['settings:defaultsnavigation:description'] = 'Set the default values for navigating through courses';
$string['settings:defaultssubsections'] = 'Subsection defaults';
$string['settings:defaultssubsections:description'] = 'Default subsection behaviour and display settings';
